package com.bank.bian.corporatetreasury.model;
...
/**
 * The BIAN control record for this service domain: "Treasury Plan Management Plan".
 *
 ...
 * to its asset type (Treasury Plan). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Treasury Plan Management Plan";
